    ...
    async mintTokens(amount: number): Promise<void> {
        try {
            ...
            toast.info(<>
                ...
                <a href={this.generateTransactionUrl(transaction.hash)} target="_blank" rel="noopener">View
                    on {this.state.networkConfig.blockExplorer.name}</a>
            </>);
            ...
            toast.success(<>
                Success!<br/>
                <a href={this.generateTransactionUrl(receipt.transactionHash)} target="_blank" rel="noopener">View
                    on {this.state.networkConfig.blockExplorer.name}</a>
            </>);
    ...
    render() {
        return (
            <>
                ...
                {this.state.errorMessage ? <div className="error"><p>{this.state.errorMessage}</p>
                    ...
                    <>
                        {this.isContractReady() ?
                            ...
                            <div className="collection-not-ready">
                                <svg className="spinner" xmlns="http://www.w3.org/2000/svg" fill="none"
                                     viewBox="0 0 24 24">
